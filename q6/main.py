...
emDolar = conversor.real_para_dolar(valor, cotacao)
emReal = conversor.dolar_para_real(valor, cotacao)

print(f"\n{valor:.2f} reais equivalem a {emDolar:.2f} dólares.")
print(f"{valor:.2f} dólares equivalem a {emReal:.2f} reais.")
